package kodlama.io.hrms.service.constants;

public class Messages {

	public static String EmployerNull = "Employer is null!";
    ...
    public static String EmployerDeleted = "Employer successfully deleted from db!";
    ...
    public static String JobNotFound = "Job is null!";
    
    public static String JobPositionManagerAdded = "Job add from db!";
    public static String JobPositionManagerFaill = "Job Faill from db!";
}
