...
export default function EmployeeUpdatePage() {
    ...
    useEffect(() => {
        if (
            ...
            service.getEmployeeById(employeeId,token).then((result) => setEmployee(result.data.employee)).catch((error) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            employeeService.updateEmployees(employeeId,employee, token)
                .then((response) => {
                    ...
                    else if(response.data === "errorUpdate") {
                        swal({
                            title: "Update error",
                            text: "Employee added. After system user's confirmation, it will be listed.",
                            icon: "error",
